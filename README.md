...
[![Email](https://img.shields.io/badge/williangoix@gmail.com-F5F5F5?style=flat&logo=Mail.Ru&logoColor=blue)](mailto:williangoix@gmail.com)
...
Key aspects:
- Asynchronous, event-driven backend using a Node.js/TypeScript monorepo with Redis and BullMQ for high responsiveness
- Deep integration with OpenAI for natural language understanding, enabling expense tracking, balance queries, and reminders via chat
- Fully containerized with Docker and deployed to production on Oracle Cloud
- Usability tested with 20 real users over 45 days, iterating based on real feedback
